...
answer1.addEventListener("click",function(){
    if(answer1.checked==true){
        ...
        userAnswerValue[1]=(Number(answer1.value));
...
answer2.addEventListener("click",function(){
    if(answer2.checked===true){
        userAnswer[1]="&lt;hr&gt;";
        localStorage.setItem("userAnswer",JSON.stringify(userAnswer));
        userAnswerValue[1]=(Number(answer2.value));
        localStorage.setItem("userAnswerValue",JSON.stringify(userAnswerValue));
        isAnswerToF[1]=false;
        localStorage.setItem("isAnswerToF",JSON.stringify(isAnswerToF));
        flag=1;
...
answer3.addEventListener("click",function(){
    if(answer3.checked===true){
        ...
        localStorage.setItem("userAnswer",JSON.stringify(userAnswer));
        userAnswerValue[1]=(Number(answer3.value));
        localStorage.setItem("userAnswerValue",JSON.stringify(userAnswerValue));
        isAnswerToF[1]=true;
        localStorage.setItem("isAnswerToF",JSON.stringify(isAnswerToF));
        flag=1;
...
answer4.addEventListener("click",function(){
    if(answer4.checked===true){
        ...
        localStorage.setItem("userAnswer",JSON.stringify(userAnswer));
        userAnswerValue[1]=(Number(answer4.value));
        localStorage.setItem("userAnswerValue",JSON.stringify(userAnswerValue));
        isAnswerToF[1]=false;
        localStorage.setItem("isAnswerToF",JSON.stringify(isAnswerToF));
        flag=1;
...
nextBtn.addEventListener("click",function(){
    if(flag==1){
        window.location.href="./q3_html.html";
    }
})
